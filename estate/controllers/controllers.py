...
class Estate(http.Controller):
      ...
      def index(self, page=1, **kw):
        ...
        if kw.get('inputdate'):
           domain = ['&',('date_availability','>',kw.get('inputdate')), ('state','in',['offer_received','offer_accepted','new'])]
        count = Property.search_count(['&',('date_availability','>',kw.get('inputdate')), ('state','in',['offer_received','offer_accepted','new'])])
